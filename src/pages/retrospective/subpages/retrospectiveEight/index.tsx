...
import { BackgroundPinkContainer, BlueBox, RetrospectiveContainer } from "./retrospectiveEight.styles";
      ...
      {isDesktop ? (
        <>
          ...
          <RetrospectiveContainer>
                ...
                <TextSideDivision>
                  ...
                  >
                    <Typography
                      ...
                      fontSize={20}
                    >
                      O que acontece no hospital não fica no hospital! Em 2022,
                      5 edições do espetáculo “Conta Causos”, com histórias de
                      hospital foram aos palcos. No primeiro semestre, os
                      palhaços levaram o espetáculo para as Fábricas de Cultura
                    </Typography>
                  </TextContainer>
                </TextSideDivision>
                <TextSideDivision>
            ...
            <BlueBox>
              <SquareColored type="primary" backgroundColor={DalegriaColorsEnum.LightBlue}>
              <TextDivision>
                <TextSideDivision>
                  <TextContainer
                    textAlign="left"
